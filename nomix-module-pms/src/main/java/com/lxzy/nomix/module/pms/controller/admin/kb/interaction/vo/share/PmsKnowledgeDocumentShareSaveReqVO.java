package com.lxzy.nomix.module.pms.controller.admin.kb.interaction.vo.share;
...
@Schema(description = "管理后台 - PMS 知识库文档分享保存 Request VO")
@Data
public class PmsKnowledgeDocumentShareSaveReqVO {
