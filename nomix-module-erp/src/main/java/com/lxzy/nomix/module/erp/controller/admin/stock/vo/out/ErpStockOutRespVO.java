package com.lxzy.nomix.module.erp.controller.admin.stock.vo.out;
...
import static com.lxzy.nomix.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "Nomix")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "创建人名称", example = "Nomix")
