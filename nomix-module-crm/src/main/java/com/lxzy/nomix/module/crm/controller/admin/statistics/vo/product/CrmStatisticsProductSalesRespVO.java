package com.lxzy.nomix.module.crm.controller.admin.statistics.vo.product;
...
public class CrmStatisticsProductSalesRespVO {
    ...
    @Schema(description = "负责人姓名", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nomix")
