package com.lxzy.nomix.module.system.controller.admin.social.vo.client;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "nomix商城")
