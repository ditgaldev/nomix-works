package com.lxzy.nomix.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "nomix")
    ...
    @Schema(description = "短信发送回调 URL", example = "http://www.nomix.cn")
