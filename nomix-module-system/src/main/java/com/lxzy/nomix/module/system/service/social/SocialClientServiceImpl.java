package com.lxzy.nomix.module.system.service.social;
...
import com.lxzy.nomix.framework.common.util.cache.CacheUtils;
import com.lxzy.nomix.framework.common.util.http.HttpUtils;
import com.lxzy.nomix.framework.common.util.object.BeanUtils;
import com.lxzy.nomix.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.lxzy.nomix.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.lxzy.nomix.module.system.controller.admin.social.vo.client.SocialClientPageReqVO;
...
import com.lxzy.nomix.module.system.dal.mysql.social.SocialClientMapper;
...
import static com.lxzy.nomix.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.lxzy.nomix.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${nomix.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${nomix.wxa-subscribe-message.miniprogram-state:formal}")
