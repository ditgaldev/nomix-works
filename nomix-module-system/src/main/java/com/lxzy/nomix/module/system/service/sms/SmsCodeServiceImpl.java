...
import com.lxzy.nomix.module.system.dal.dataobject.sms.SmsCodeDO;
import com.lxzy.nomix.module.system.dal.mysql.sms.SmsCodeMapper;
import com.lxzy.nomix.module.system.enums.sms.SmsSceneEnum;
import com.lxzy.nomix.module.system.framework.sms.config.SmsCodeProperties;
...
import static com.lxzy.nomix.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO Nomix：提升，每个 IP 每天可发送数量
            // TODO Nomix：提升，每个 IP 每小时可发送数量
        }
