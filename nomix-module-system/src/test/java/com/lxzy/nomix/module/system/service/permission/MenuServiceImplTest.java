...
import com.lxzy.nomix.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.lxzy.nomix.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.lxzy.nomix.module.system.dal.dataobject.permission.MenuDO;
import com.lxzy.nomix.module.system.dal.mysql.permission.MenuMapper;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("Nomix").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
