package com.lxzy.nomix.module.system.service.user;
...
import com.lxzy.nomix.module.infra.api.config.ConfigApi;
import com.lxzy.nomix.module.infra.api.file.FileApi;
import com.lxzy.nomix.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.lxzy.nomix.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.lxzy.nomix.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.lxzy.nomix.module.system.controller.admin.user.vo.user.UserImportRespVO;
...
import com.lxzy.nomix.module.system.dal.dataobject.dept.DeptDO;
import com.lxzy.nomix.module.system.dal.dataobject.dept.PostDO;
import com.lxzy.nomix.module.system.dal.dataobject.dept.UserPostDO;
...
import com.lxzy.nomix.module.system.dal.mysql.dept.UserPostMapper;
import com.lxzy.nomix.module.system.dal.mysql.user.AdminUserMapper;
import com.lxzy.nomix.module.system.enums.common.SexEnum;
import com.lxzy.nomix.module.system.mq.producer.user.AdminUserProducer;
import com.lxzy.nomix.module.system.service.dept.DeptService;
import com.lxzy.nomix.module.system.service.dept.PostService;
...
import static com.lxzy.nomix.module.system.enums.ErrorCodeConstants.*;
import static com.lxzy.nomix.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("nomixyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("nomixyuanma");
        ...
        assertEquals("nomixyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("nomixyuanma"))).thenReturn("java");
