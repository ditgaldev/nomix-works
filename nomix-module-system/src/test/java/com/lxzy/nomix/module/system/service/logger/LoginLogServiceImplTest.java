...
import com.lxzy.nomix.module.system.dal.mysql.logger.LoginLogMapper;
...
import static com.lxzy.nomix.module.system.enums.logger.LoginResultEnum.CAPTCHA_CODE_ERROR;
import static com.lxzy.nomix.module.system.enums.logger.LoginResultEnum.SUCCESS;
...
public class LoginLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetLoginLogPage() {
        ...
        // 测试 username 不匹配
        loginLogMapper.insert(cloneIgnoreId(loginLogDO, o -> o.setUsername("nomix")));
        // 测试 createTime 不匹配
