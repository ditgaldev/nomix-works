package com.lxzy.nomix.module.system.service.mail;
...
import com.lxzy.nomix.framework.test.core.util.RandomUtils;
import com.lxzy.nomix.module.system.dal.dataobject.mail.MailAccountDO;
import com.lxzy.nomix.module.system.dal.dataobject.mail.MailTemplateDO;
import com.lxzy.nomix.module.system.dal.dataobject.user.AdminUserDO;
import com.lxzy.nomix.module.system.mq.message.mail.MailSendMessage;
import com.lxzy.nomix.module.system.mq.producer.mail.MailProducer;
...
//                .setFrom("奥特曼 <ydym_test@163.com>")
    ...
    public void testDoSendMail_success() {
        try (final MockedStatic<MailUtil> mailUtilMock = mockStatic(MailUtil.class)) {
            // 准备参数
            MailSendMessage message = randomPojo(MailSendMessage.class, o -> o.setNickname("Nomix"));
            // mock 方法（获得邮箱账号）
            ...
            mailUtilMock.when(() -> MailUtil.send(
                    argThat(mailAccount -> {
                        assertEquals("Nomix <7685@qq.com>", mailAccount.getFrom());
