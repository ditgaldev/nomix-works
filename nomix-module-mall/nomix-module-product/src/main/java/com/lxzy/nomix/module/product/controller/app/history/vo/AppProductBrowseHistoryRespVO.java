package com.lxzy.nomix.module.product.controller.app.history.vo;
...
public class AppProductBrowseHistoryRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nomix.cn/pic.png")
