package com.lxzy.nomix.module.trade.controller.app.order.vo;
...
public class AppTradeOrderSettlementRespVO {
    ...
    public static class Item {
        ...
        @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nomix.cn/1.png")
