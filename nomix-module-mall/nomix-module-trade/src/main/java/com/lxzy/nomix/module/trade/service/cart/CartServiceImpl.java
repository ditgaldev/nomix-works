package com.lxzy.nomix.module.trade.service.cart;
...
import com.lxzy.nomix.module.trade.controller.app.cart.vo.*;
import com.lxzy.nomix.module.trade.convert.cart.TradeCartConvert;
import com.lxzy.nomix.module.trade.dal.dataobject.cart.CartDO;
import com.lxzy.nomix.module.trade.dal.mysql.cart.CartMapper;
...
import static com.lxzy.nomix.module.product.enums.ErrorCodeConstants.SKU_STOCK_NOT_ENOUGH;
import static com.lxzy.nomix.module.trade.enums.ErrorCodeConstants.CARD_ITEM_NOT_FOUND;
import static java.util.Collections.emptyList;

/**
 * 购物车 Service 实现类
 *
 * // TODO Nomix：未来优化：购物车的价格计算，支持营销信息；目前不支持的原因，前端界面需要前端 pr 支持下；例如说：会员价格；
 *
 * @author Nomix
 */
@Service
