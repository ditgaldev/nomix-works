package com.lxzy.nomix.module.trade.convert.order;
...
import com.lxzy.nomix.module.pay.enums.DictTypeConstants;
import com.lxzy.nomix.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.lxzy.nomix.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
...
import com.lxzy.nomix.module.trade.api.order.dto.TradeOrderRespDTO;
import com.lxzy.nomix.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.lxzy.nomix.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.lxzy.nomix.module.trade.controller.admin.order.vo.*;
import com.lxzy.nomix.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.lxzy.nomix.module.trade.controller.app.order.vo.*;
import com.lxzy.nomix.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.lxzy.nomix.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.lxzy.nomix.module.trade.dal.dataobject.order.TradeOrderLogDO;
...
import static com.lxzy.nomix.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default PayOrderCreateReqDTO convert(TradeOrderDO order, List<TradeOrderItemDO> orderItems,
        ...
        createReqDTO.setBody(subject); // TODO Nomix：临时写死
        // 订单相关字段
