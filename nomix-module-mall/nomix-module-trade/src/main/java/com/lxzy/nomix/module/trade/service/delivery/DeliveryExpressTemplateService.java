...
import com.lxzy.nomix.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateCreateReqVO;
import com.lxzy.nomix.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateDetailRespVO;
import com.lxzy.nomix.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplatePageReqVO;
import com.lxzy.nomix.module.trade.controller.admin.delivery.vo.expresstemplate.DeliveryExpressTemplateUpdateReqVO;
...
public interface DeliveryExpressTemplateService {
     ...
     * 校验快递运费模板
     *
     * 如果校验不通过，抛出 {@link com.lxzy.nomix.framework.common.exception.ServiceException} 异常
     *
