...
import com.lxzy.nomix.module.product.api.sku.ProductSkuApi;
import com.lxzy.nomix.module.product.api.spu.ProductSpuApi;
import com.lxzy.nomix.module.promotion.api.coupon.CouponApi;
import com.lxzy.nomix.module.system.api.notify.NotifyMessageSendApi;
import com.lxzy.nomix.module.trade.controller.admin.delivery.vo.express.DeliveryExpressCreateReqVO;
...
import com.lxzy.nomix.module.trade.enums.order.TradeOrderRefundStatusEnum;
import com.lxzy.nomix.module.trade.enums.order.TradeOrderStatusEnum;
import com.lxzy.nomix.module.trade.framework.order.config.TradeOrderConfig;
import com.lxzy.nomix.module.trade.framework.order.config.TradeOrderProperties;
import com.lxzy.nomix.module.trade.service.cart.CartServiceImpl;
import com.lxzy.nomix.module.trade.service.delivery.DeliveryExpressService;
import com.lxzy.nomix.module.trade.service.delivery.DeliveryExpressServiceImpl;
import com.lxzy.nomix.module.trade.service.message.TradeMessageServiceImpl;
import com.lxzy.nomix.module.trade.service.order.handler.TradeOrderHandler;
import com.lxzy.nomix.module.trade.service.price.TradePriceServiceImpl;
...
//        // mock 方法（用户收件地址的校验）
//        MemberAddressRespDTO addressRespDTO = new MemberAddressRespDTO().setId(10L).setUserId(userId).setName("Nomix")
...
//        assertEquals(tradeOrderDO.getReceiverName(), "Nomix");
