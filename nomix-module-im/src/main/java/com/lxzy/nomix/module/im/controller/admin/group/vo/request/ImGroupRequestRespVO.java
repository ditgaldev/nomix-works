package com.lxzy.nomix.module.im.controller.admin.group.vo.request;
...
public class ImGroupRequestRespVO {
    ...
    @Schema(description = "申请人 / 被邀请人昵称（实时聚合自 AdminUser）", example = "Nomix")
    ...
    @Schema(description = "群名称（实时聚合自 ImGroup）", example = "Nomix技术交流群")
