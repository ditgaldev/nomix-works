package com.lxzy.nomix.module.im.controller.admin.friend.vo.request;

import com.lxzy.nomix.framework.common.validation.InEnum;
import com.lxzy.nomix.module.im.enums.friend.ImFriendAddSourceEnum;
...
public class ImFriendRequestApplyReqVO {
    ...
    @Schema(description = "申请理由", example = "我是Nomix（一种食材）")
