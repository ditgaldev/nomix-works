package com.lxzy.nomix.module.im.dal.mysql.message;
...
public class ImGroupMessageMapperTest extends BaseDbUnitTest {
    ...
    public void testSelectListByMinId_filterByReceiverSnapshot() {
        ...
        ImGroupMessageDO visible = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L, 2L));
        mapper.insert(visible);
        ImGroupMessageDO invisible = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(2L, 3L));
        mapper.insert(invisible);
        ImGroupMessageDO selfSend = buildMessage(10L, 1L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L, 2L));
        mapper.insert(selfSend);

        // 调用：用户 1 拉取群 10
        List<ImGroupMessageDO> result = mapper.selectListByMinId(1L, Arrays.asList(10L), 0L, FAR_PAST, 100);
    ...
    public void testSelectListByMinId_excludeNullAndEmptySnapshot() {
        ...
        ImGroupMessageDO emptySnapshot = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Collections.emptyList());
    ...
    public void testSelectListByMinId_onlyReturnsGroupsInIdList() {
        ...
        ImGroupMessageDO msg10 = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L, 2L));
        mapper.insert(msg10);
        ImGroupMessageDO msg20 = buildMessage(20L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L, 2L));
        mapper.insert(msg20);
    ...
    public void testSelectListByMinId_includesRecall() {
        ...
        ImGroupMessageDO normal = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L));
        mapper.insert(normal);
        ImGroupMessageDO recalled = buildMessage(10L, 2L, ImMessageStatusEnum.RECALL, Arrays.asList(1L));
    ...
    public void testSelectListByMinId_sendTimeWindow() {
        // 准备：一条在窗口内，一条在窗口外
        ImGroupMessageDO inWindow = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L));
        inWindow.setSendTime(LocalDateTime.now().minusDays(1));
        mapper.insert(inWindow);
        ImGroupMessageDO outWindow = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L));
        outWindow.setSendTime(LocalDateTime.now().minusDays(40));
        mapper.insert(outWindow);

        List<ImGroupMessageDO> result = mapper.selectListByMinId(1L, Arrays.asList(10L), 0L,
    ...
    public void testSelectListByMinId_sortAscLimit() {
        // 准备：插入 3 条可见消息
        ImGroupMessageDO m1 = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L));
        mapper.insert(m1);
        ImGroupMessageDO m2 = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L));
        mapper.insert(m2);
        ImGroupMessageDO m3 = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L));
        mapper.insert(m3);

        // 调用：size=2，返回 id 最小的 2 条
        List<ImGroupMessageDO> result = mapper.selectListByMinId(1L, Arrays.asList(10L), 0L, FAR_PAST, 2);
    ...
    public void testSelectListByMinId_minIdExclusive() {
        ...
        List<ImGroupMessageDO> result = mapper.selectListByMinId(1L, Arrays.asList(10L), m1.getId(), FAR_PAST, 100);
    ...
    public void testSelectHistoryListByUser_filterByReceiverSnapshot() {
        ...
        ImGroupMessageDO m1 = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L, 2L));
        mapper.insert(m1);
        ImGroupMessageDO m2 = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L, 2L));
        mapper.insert(m2);
        ImGroupMessageDO directedOther = buildMessage(10L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(2L, 3L));
        mapper.insert(directedOther);
        // 别的群
        ImGroupMessageDO other = buildMessage(20L, 2L, ImMessageStatusEnum.NORMAL, Arrays.asList(1L));
        mapper.insert(other);
