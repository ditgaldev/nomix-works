package com.lxzy.nomix.module.infra.service.db;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.crypto.symmetric.AES;
import com.lxzy.nomix.framework.mybatis.core.type.EncryptTypeHandler;
...
import static com.lxzy.nomix.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
...
public class DataSourceConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUp() {
        ...
        dataSourceProperty.setUsername("nomix");
    ...
    public void testGetDataSourceConfig_master() {
        ...
        assertEquals("nomix", dataSourceConfig.getUsername());
    ...
    public void testGetDataSourceConfigList() {
        ...
        assertEquals("nomix", dataSourceConfigList.get(0).getUsername());
