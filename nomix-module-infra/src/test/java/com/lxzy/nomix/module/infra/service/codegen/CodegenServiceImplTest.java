package com.lxzy.nomix.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import com.lxzy.nomix.framework.common.pojo.PageResult;
import com.lxzy.nomix.framework.test.core.ut.BaseDbUnitTest;
import com.lxzy.nomix.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.lxzy.nomix.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.lxzy.nomix.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import com.lxzy.nomix.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.lxzy.nomix.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.lxzy.nomix.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.lxzy.nomix.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.lxzy.nomix.module.infra.dal.dataobject.db.DataSourceConfigDO;
import com.lxzy.nomix.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.lxzy.nomix.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.lxzy.nomix.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.lxzy.nomix.module.infra.enums.codegen.CodegenSceneEnum;
import com.lxzy.nomix.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.lxzy.nomix.module.infra.framework.codegen.config.CodegenProperties;
import com.lxzy.nomix.module.infra.service.codegen.inner.CodegenBuilder;
import com.lxzy.nomix.module.infra.service.codegen.inner.CodegenEngine;
import com.lxzy.nomix.module.infra.service.db.DataSourceConfigService;
import com.lxzy.nomix.module.infra.service.db.DatabaseTableService;
...
import static com.lxzy.nomix.module.infra.enums.ErrorCodeConstants.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        CodegenCreateListReqVO reqVO = randomPojo(CodegenCreateListReqVO.class,
                o -> o.setDataSourceConfigId(1L).setTableNames(Collections.singletonList("t_nomix")));
        // mock 方法（TableInfo）
        TableInfo tableInfo = mock(TableInfo.class);
        when(databaseTableService.getTable(eq(1L), eq("t_nomix")))
                .thenReturn(tableInfo);
        when(tableInfo.getComment()).thenReturn("Nomix");
    ...
    public void testSyncCodegenFromDB() {
        ...
        CodegenTableDO table = randomPojo(CodegenTableDO.class, o -> o.setTableName("t_nomix")
    ...
    public void testGetCodegenTablePage() {
        ...
        CodegenTableDO tableDO = randomPojo(CodegenTableDO.class, o -> {
            o.setTableName("t_nomix");
            o.setTableComment("Nomix");
            o.setClassName("SystemNomix");
        ...
        reqVO.setTableName("nomix");
        reqVO.setTableComment("芋");
        reqVO.setClassName("Nomix");
    ...
    public void testGetDatabaseTableList() {
        ...
        when(tableInfo01.getName()).thenReturn("t_nomix");
        when(tableInfo01.getComment()).thenReturn("Nomix");
        TableInfo tableInfo02 = mock(TableInfo.class);
        when(tableInfo02.getName()).thenReturn("t_nomix_02");
        when(tableInfo02.getComment()).thenReturn("Nomix_02");
        ...
        // 断言
        assertEquals(1, result.size());
        assertEquals("t_nomix", result.get(0).getName());
        assertEquals("Nomix", result.get(0).getComment());
    }
