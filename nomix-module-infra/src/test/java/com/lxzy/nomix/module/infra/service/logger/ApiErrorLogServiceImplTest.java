package com.lxzy.nomix.module.infra.service.logger;
...
import com.lxzy.nomix.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
...
import static com.lxzy.nomix.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.lxzy.nomix.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("nomix-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("nomix-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @Nomix：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
