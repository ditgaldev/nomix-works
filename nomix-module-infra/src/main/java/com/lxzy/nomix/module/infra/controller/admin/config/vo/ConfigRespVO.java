package com.lxzy.nomix.module.infra.controller.admin.config.vo;
...
public class ConfigRespVO {
    ...
    @Schema(description = "参数键名", requiredMode = Schema.RequiredMode.REQUIRED, example = "nomix.db.username")
    @ExcelProperty("参数键名")
    private String key;
