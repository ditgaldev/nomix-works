package com.lxzy.nomix.module.infra.controller.admin.codegen;
...
import com.lxzy.nomix.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.lxzy.nomix.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.lxzy.nomix.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.lxzy.nomix.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.lxzy.nomix.module.infra.convert.codegen.CodegenConvert;
...
import com.lxzy.nomix.module.infra.service.codegen.CodegenService;
...
import static com.lxzy.nomix.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.lxzy.nomix.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "nomix"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "Nomix")
    })
