package com.lxzy.nomix.module.pay.framework.pay.core.client.impl.alipay;
...
import static com.lxzy.nomix.module.pay.framework.pay.core.client.impl.alipay.AlipayPayClientConfig.MODE_CERTIFICATE;
import static com.lxzy.nomix.module.pay.framework.pay.core.client.impl.alipay.AlipayPayClientConfig.MODE_PUBLIC_KEY;
...
public abstract class AbstractAlipayPayClient extends AbstractPayClient<AlipayPayClientConfig> {
    ...
    // TODO @Nomix：由于支付宝一直没触发回调，这个方法暂时没办法测试
    @Override
