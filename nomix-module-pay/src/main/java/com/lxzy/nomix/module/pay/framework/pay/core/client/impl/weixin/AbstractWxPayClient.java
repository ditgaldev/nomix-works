package com.lxzy.nomix.module.pay.framework.pay.core.client.impl.weixin;
...
import static com.lxzy.nomix.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.lxzy.nomix.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
    ...
    protected PayOrderRespDTO doUnifiedOrder(PayOrderUnifiedReqDTO reqDTO) throws Exception {
        try {
            switch (config.getApiVersion()) {
                ...
                case API_VERSION_V3:
                    // TODO @Nomix：【可能是 wxjava 的 bug】参考 https://github.com/binarywang/WxJava/issues/1557
