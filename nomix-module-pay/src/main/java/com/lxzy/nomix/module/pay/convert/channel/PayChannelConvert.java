package com.lxzy.nomix.module.pay.convert.channel;
...
import com.lxzy.nomix.module.pay.controller.admin.channel.vo.PayChannelRespVO;
...
public interface PayChannelConvert {
    ...
    @Mapping(target = "config",expression = "java(com.lxzy.nomix.framework.common.util.json.JsonUtils.toJsonString(bean.getConfig()))")
