package com.lxzy.nomix.module.pay.controller.admin.demo.vo.withdraw;
...
public class PayDemoWithdrawCreateReqVO {
    ...
    @Schema(description = "提现标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nomix是一种菜")
