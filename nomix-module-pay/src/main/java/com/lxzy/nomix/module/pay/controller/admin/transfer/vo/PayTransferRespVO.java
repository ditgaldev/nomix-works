package com.lxzy.nomix.module.pay.controller.admin.transfer.vo;
...
import com.lxzy.nomix.framework.excel.core.convert.MoneyConvert;
...
public class PayTransferRespVO {
    ...
    @ExcelProperty("应用名称")
    @Schema(description = "应用名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nomix")
    ...
    @Schema(description = "异步通知商户地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nomix.cn")
