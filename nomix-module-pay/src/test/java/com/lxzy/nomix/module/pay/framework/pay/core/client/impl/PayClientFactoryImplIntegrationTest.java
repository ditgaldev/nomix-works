package com.lxzy.nomix.module.pay.framework.pay.core.client.impl;
...
import com.lxzy.nomix.module.pay.framework.pay.core.client.impl.PayClientFactoryImpl;
import com.lxzy.nomix.module.pay.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import com.lxzy.nomix.module.pay.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import com.lxzy.nomix.module.pay.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import com.lxzy.nomix.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig;
import com.lxzy.nomix.module.pay.framework.pay.core.client.impl.weixin.WxPubPayClient;
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_WX_PUB_V3() throws FileNotFoundException {
        ...
        config.setPrivateKeyContent(IoUtil.readUtf8(new FileInputStream("/Users/nomix/Downloads/wx_pay/apiclient_key.pem")));
//        config.setPrivateCertContent(IoUtil.readUtf8(new FileInputStream("/Users/nomix/Downloads/wx_pay/apiclient_cert.pem")));
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_ALIPAY_QR() {
        ...
        // 发起支付
        PayOrderUnifiedReqDTO reqDTO = buildPayOrderUnifiedReqDTO();
        reqDTO.setNotifyUrl("http://nomix.natapp1.cc/admin-api/pay/notify/callback/18"); // TODO @tina: 这里改成你的 natapp 回调地址
