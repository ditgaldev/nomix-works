...
public class FmsSubjectDO extends BaseDO {
     ...
     * 科目类型
     *
     * 枚举 {@link com.lxzy.nomix.module.fms.enums.config.FmsSubjectTypeEnum}
     */
     ...
     * 状态
     *
     * 枚举 {@link com.lxzy.nomix.framework.common.enums.CommonStatusEnum}
     */
     ...
     * 核算币种编号数组
     *
     * 关联 {@link com.lxzy.nomix.module.fms.dal.dataobject.config.FmsCurrencyDO#getId()}
     */
    @TableField(typeHandler = JacksonTypeHandler.class)
