package com.lxzy.nomix.module.fms.controller.admin.ledger.vo.auxiliarydetail;
...
@Schema(description = "管理后台 - FMS 核算项目明细账 Response VO")
@Data
@ExcelIgnoreUnannotated
public class FmsLedgerAuxiliaryDetailRespVO {
