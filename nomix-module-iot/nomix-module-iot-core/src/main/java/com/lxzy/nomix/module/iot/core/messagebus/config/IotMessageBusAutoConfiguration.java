package com.lxzy.nomix.module.iot.core.messagebus.config;

import com.lxzy.nomix.framework.mq.redis.core.RedisMQTemplate;
import com.lxzy.nomix.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.lxzy.nomix.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.lxzy.nomix.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.lxzy.nomix.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.lxzy.nomix.module.iot.core.messagebus.core.IotMessageBus;
import com.lxzy.nomix.module.iot.core.messagebus.core.kafka.IotKafkaMessageBus;
import com.lxzy.nomix.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.lxzy.nomix.module.iot.core.messagebus.core.rabbitmq.IotRabbitMQMessageBus;
import com.lxzy.nomix.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.lxzy.nomix.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
import com.lxzy.nomix.module.iot.core.mq.producer.IotDeviceMessageProducer;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "nomix.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "nomix.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "nomix.iot.message-bus", name = "type", havingValue = "kafka")
    ...
    /**
     * 特殊：由于 NomixRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.lxzy.nomix.framework.mq.redis.config.NomixRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "nomix.iot.message-bus", name = "type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "nomix.iot.message-bus", name = "type", havingValue = "rabbitmq")
