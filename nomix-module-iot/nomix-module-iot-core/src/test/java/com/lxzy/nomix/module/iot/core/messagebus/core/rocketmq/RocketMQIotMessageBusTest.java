package com.lxzy.nomix.module.iot.core.messagebus.core.rocketmq;

import cn.hutool.core.util.IdUtil;
import com.lxzy.nomix.module.iot.core.messagebus.config.IotMessageBusAutoConfiguration;
...
import com.lxzy.nomix.module.iot.core.messagebus.core.TestMessage;
...
@TestPropertySource(properties = {
        "nomix.iot.message-bus.type=rocketmq",
...
//                return "test-topic-consumer-01";
    ...
    public void testSendMessageWithTwoSubscribers() throws InterruptedException {
        ...
        String topic = "test-topic-" + IdUtil.simpleUUID();
//        String topic = "test-topic-pojo";
        TestMessage testMessage = new TestMessage().setNickname("nomix").setAge(18);
        // 用于等待消息处理完成
