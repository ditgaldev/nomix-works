package com.lxzy.nomix.module.iot.service.rule.action.databridge;
...
import com.lxzy.nomix.module.iot.dal.dataobject.rule.config.*;
import com.lxzy.nomix.module.iot.service.rule.data.action.*;
...
public class IotDataBridgeExecuteTest extends BaseMockitoUnitTest {
    ...
    public void testHttpDataBridge() throws Exception {
        ...
        IotDataSinkHttpConfig config = new IotDataSinkHttpConfig()
                .setUrl("https://doc.nomix.cn/").setMethod(HttpMethod.GET.name());
