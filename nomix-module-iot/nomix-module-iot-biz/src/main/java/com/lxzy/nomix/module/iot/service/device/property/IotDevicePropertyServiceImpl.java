package com.lxzy.nomix.module.iot.service.device.property;
...
import com.lxzy.nomix.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import com.lxzy.nomix.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
...
import com.lxzy.nomix.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import com.lxzy.nomix.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import com.lxzy.nomix.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import com.lxzy.nomix.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import com.lxzy.nomix.module.iot.dal.tdengine.IotDevicePropertyMapper;
...
import static com.lxzy.nomix.framework.common.util.collection.MapUtils.getBigDecimal;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void saveDeviceProperty(IotDeviceDO device, IotDeviceMessage message) {
        ...
        // 1. 根据物模型，拼接合法的属性
        // TODO @Nomix：【待定 004】赋能后，属性到底以 thingModel 为准（ik），还是 db 的表结构为准（tl）？
