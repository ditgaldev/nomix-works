package com.lxzy.nomix.module.iot.service.device.message;
...
import com.lxzy.nomix.module.iot.controller.admin.device.vo.message.IotDeviceMessagePageReqVO;
import com.lxzy.nomix.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import com.lxzy.nomix.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
...
import com.lxzy.nomix.module.iot.core.topic.event.IotDeviceEventPostReqDTO;
import com.lxzy.nomix.module.iot.core.topic.property.IotDevicePropertyPackPostReqDTO;
import com.lxzy.nomix.module.iot.core.topic.property.IotDevicePropertyPostReqDTO;
...
import com.lxzy.nomix.module.iot.dal.tdengine.IotDeviceMessageMapper;
...
import static com.lxzy.nomix.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
...
public class IotDeviceMessageServiceImpl implements IotDeviceMessageService {
    ...
    private IotDeviceMessage sendDeviceMessage(IotDeviceMessage message, IotDeviceDO device, String serverId) {
        ...
        // TODO Nomix：【设计】下行消息需要区分 PUSH 和 PULL 模型
    ...
    // TODO @Nomix：可优化：未来逻辑复杂后，可以独立拆除 Processor 处理器
