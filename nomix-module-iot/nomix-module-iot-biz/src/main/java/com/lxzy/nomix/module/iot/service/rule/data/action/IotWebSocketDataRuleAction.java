package com.lxzy.nomix.module.iot.service.rule.data.action;

import cn.hutool.core.util.StrUtil;
import com.lxzy.nomix.module.iot.core.mq.message.IotDeviceMessage;
import com.lxzy.nomix.module.iot.dal.dataobject.rule.config.IotDataSinkWebSocketConfig;
import com.lxzy.nomix.module.iot.enums.rule.IotDataSinkTypeEnum;
import com.lxzy.nomix.module.iot.service.rule.data.action.websocket.IotWebSocketClient;
...
public class IotWebSocketDataRuleAction extends
     ...
     *
     * 加锁原因：多线程并发发送消息时，多个线程可能同时检测到连接断开并尝试重连，使用锁 + 双重检查保证同一服务器地址只有一个线程执行重连操作
     *
