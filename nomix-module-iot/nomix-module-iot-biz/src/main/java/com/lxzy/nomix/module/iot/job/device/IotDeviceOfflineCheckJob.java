package com.lxzy.nomix.module.iot.job.device;
...
import com.lxzy.nomix.module.iot.framework.iot.config.NomixIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private NomixIotProperties iotProperties;
