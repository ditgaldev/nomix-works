package com.lxzy.nomix.module.iot.service.product;
...
import com.lxzy.nomix.module.iot.dal.mysql.product.IotProductMapper;
...
public class IotProductServiceImpl implements IotProductService {
    ...
    public void updateProductStatus(Long id, Integer status) {
        ...
        // TODO @Nomix：【待定 001】1）是否需要操作后，在 redis 进行缓存，实现一个“快照”的情况，类似 tl；
