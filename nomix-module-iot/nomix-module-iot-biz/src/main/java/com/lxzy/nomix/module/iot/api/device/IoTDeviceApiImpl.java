package com.lxzy.nomix.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.lxzy.nomix.framework.common.enums.RpcConstants;
...
import com.lxzy.nomix.module.iot.service.device.IotDeviceModbusConfigService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 nomix-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
