...
import com.lxzy.nomix.module.iot.gateway.protocol.coap.IotCoapConfig;
import com.lxzy.nomix.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import com.lxzy.nomix.module.iot.gateway.protocol.http.IotHttpConfig;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import com.lxzy.nomix.module.iot.gateway.protocol.mqtt.IotMqttConfig;
...
@ConfigurationProperties(prefix = "nomix.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see com.lxzy.nomix.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see com.lxzy.nomix.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
