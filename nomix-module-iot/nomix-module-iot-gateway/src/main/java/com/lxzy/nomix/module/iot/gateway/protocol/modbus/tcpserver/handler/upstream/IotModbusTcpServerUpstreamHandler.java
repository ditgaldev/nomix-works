package com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import com.lxzy.nomix.framework.common.exception.enums.GlobalErrorCodeConstants;
...
import com.lxzy.nomix.module.iot.core.biz.dto.IotModbusPointRespDTO;
import com.lxzy.nomix.module.iot.core.enums.IotDeviceMessageMethodEnum;
import com.lxzy.nomix.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
...
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import com.lxzy.nomix.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import com.lxzy.nomix.module.iot.gateway.service.device.IotDeviceService;
import com.lxzy.nomix.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static com.lxzy.nomix.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.lxzy.nomix.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.lxzy.nomix.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link com.lxzy.nomix.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
