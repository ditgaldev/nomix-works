package com.lxzy.nomix.module.wms.controller.admin.order.shipment.vo.order;
...
import com.lxzy.nomix.module.wms.enums.DictTypeConstants;
...
public class WmsShipmentOrderRespVO {
    ...
    @Schema(description = "创建者名称", example = "Nomix")
    ...
    @Schema(description = "更新者名称", example = "Nomix")
