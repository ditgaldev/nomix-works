...
public class BpmTaskRespVO {
    ...
    @Schema(description = "任务名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nomix")
    private String name;
    ...
    public static class ProcessInstance {
        ...
        @Schema(description = "流程实例名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nomix")
        private String name;
