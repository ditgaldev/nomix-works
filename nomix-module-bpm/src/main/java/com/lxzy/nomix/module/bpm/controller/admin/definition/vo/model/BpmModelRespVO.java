package com.lxzy.nomix.module.bpm.controller.admin.definition.vo.model;

import com.lxzy.nomix.module.bpm.controller.admin.base.dept.DeptSimpleBaseVO;
...
public class BpmModelRespVO extends BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "process_nomix")
    private String key;

    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nomix")
    private String name;
