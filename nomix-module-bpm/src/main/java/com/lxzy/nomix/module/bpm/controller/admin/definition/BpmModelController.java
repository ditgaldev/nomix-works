package com.lxzy.nomix.module.bpm.controller.admin.definition;
...
import com.lxzy.nomix.module.bpm.controller.admin.definition.vo.model.*;
...
import com.lxzy.nomix.module.bpm.convert.definition.BpmModelConvert;
...
import com.lxzy.nomix.module.bpm.service.definition.BpmCategoryService;
...
import static com.lxzy.nomix.module.bpm.enums.ErrorCodeConstants.MODEL_IMPORT_FAIL_INVALID;
...
public class BpmModelController {
    ...
    @Parameter(name = "name", description = "模型名称", example = "Nomix")
    ...
    @Parameters({
            ...
            @Parameter(name = "key", description = "流程标识，替换导入文件中的标识", example = "process_nomix"),
            @Parameter(name = "name", description = "流程名称，替换导入文件中的名称", example = "Nomix")
    })
