package com.lxzy.nomix.module.ai.util;
...
import static com.lxzy.nomix.module.ai.enums.ErrorCodeConstants.API_CONFIG_PLACEHOLDER_NOT_RESOLVED;
        ...
        switch (platform) {
            case TONG_YI:
                return DashScopeChatOptions.builder().model(model).temperature(temperature).maxToken(maxTokens)
                        .enableThinking(true) // TODO Nomix：默认都开启 thinking 模式，后续可以让用户配置
