package com.lxzy.nomix.module.ai.framework.ai.core.model;
...
import com.lxzy.nomix.module.ai.framework.ai.config.AiAutoConfiguration;
import com.lxzy.nomix.module.ai.framework.ai.config.NomixAiProperties;
...
import com.lxzy.nomix.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.lxzy.nomix.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String rawApiKey, String rawUrl) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            NomixAiProperties.Midjourney properties = SpringUtil.getBean(NomixAiProperties.class)
                    .getMidjourney();
    ...
    private ChatModel buildYiYanChatModel(String apiKey) {
        NomixAiProperties.YiYan properties = new NomixAiProperties.YiYan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(NomixAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        NomixAiProperties.Gemini properties = SpringUtil.getBean(NomixAiProperties.class)
    ...
    private GrokChatModel buildGrokChatModel(String apiKey, String url) {
        NomixAiProperties.Grok properties = new NomixAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
