package com.lxzy.nomix.module.ai.service.chat;
...
import com.lxzy.nomix.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.lxzy.nomix.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.lxzy.nomix.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.lxzy.nomix.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.lxzy.nomix.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.lxzy.nomix.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.lxzy.nomix.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.lxzy.nomix.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.lxzy.nomix.module.ai.dal.dataobject.model.AiModelDO;
import com.lxzy.nomix.module.ai.dal.dataobject.model.AiToolDO;
import com.lxzy.nomix.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.lxzy.nomix.module.ai.enums.ErrorCodeConstants;
import com.lxzy.nomix.module.ai.enums.model.AiPlatformEnum;
import com.lxzy.nomix.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.lxzy.nomix.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.lxzy.nomix.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.lxzy.nomix.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.lxzy.nomix.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.lxzy.nomix.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.lxzy.nomix.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.lxzy.nomix.module.ai.service.model.AiChatRoleService;
import com.lxzy.nomix.module.ai.service.model.AiModelService;
import com.lxzy.nomix.module.ai.service.model.AiToolService;
import com.lxzy.nomix.module.ai.util.AiUtils;
import com.lxzy.nomix.module.ai.util.FileTypeUtils;
...
import static com.lxzy.nomix.framework.common.pojo.CommonResult.error;
...
import static com.lxzy.nomix.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.lxzy.nomix.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    // TODO @Nomix：后续优化下对话的 Prompt 整体结构
    ...
    @Autowired(required = false) // 由于 nomix.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 nomix.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
