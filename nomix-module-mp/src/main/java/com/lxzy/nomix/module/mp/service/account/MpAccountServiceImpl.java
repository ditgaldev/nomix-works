package com.lxzy.nomix.module.mp.service.account;
...
import com.lxzy.nomix.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.lxzy.nomix.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.lxzy.nomix.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.lxzy.nomix.module.mp.convert.account.MpAccountConvert;
import com.lxzy.nomix.module.mp.dal.dataobject.account.MpAccountDO;
import com.lxzy.nomix.module.mp.dal.mysql.account.MpAccountMapper;
import com.lxzy.nomix.module.mp.enums.ErrorCodeConstants;
...
import static com.lxzy.nomix.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 nomix-module-mp - 表结构未导入][参考 https://doc.nomix.cn/mp/build/ 开启]");
            }
