package com.lxzy.nomix.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${nomix.websocket.sender-rocketmq.topic}",
        consumerGroup = "${nomix.websocket.sender-rocketmq.consumer-group}",
