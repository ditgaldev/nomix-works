...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("Nomix");
        ...
        desensitizeDemo.setRegex("你好，我是Nomix");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("Nomix");
        ...
        assertEquals("Nomix", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "Nomix", replacer = "*")
