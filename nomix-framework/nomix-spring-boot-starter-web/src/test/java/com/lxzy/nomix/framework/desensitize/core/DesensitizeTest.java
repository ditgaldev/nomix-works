package com.lxzy.nomix.framework.desensitize.core;

import com.lxzy.nomix.framework.common.util.json.JsonUtils;
import com.lxzy.nomix.framework.desensitize.core.annotation.Address;
import com.lxzy.nomix.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.lxzy.nomix.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.lxzy.nomix.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("Nomix源码");
        ...
        desensitizeDemo.setRegex("你好，我是Nomix源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("Nomix源码");
        ...
        assertEquals("Nomix源码", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "Nomix源码", replacer = "*")
