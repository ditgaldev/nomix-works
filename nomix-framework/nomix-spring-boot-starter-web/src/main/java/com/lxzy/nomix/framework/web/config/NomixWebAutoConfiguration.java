package com.lxzy.nomix.framework.web.config;
...
import com.lxzy.nomix.framework.web.core.filter.CacheRequestBodyFilter;
import com.lxzy.nomix.framework.web.core.filter.DemoFilter;
import com.lxzy.nomix.framework.web.core.handler.GlobalExceptionHandler;
import com.lxzy.nomix.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class NomixWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "nomix.demo", havingValue = "true")
