package com.lxzy.nomix.framework.tenant.config;

import com.lxzy.nomix.framework.common.biz.system.tenant.TenantCommonApi;
...
import com.lxzy.nomix.framework.redis.config.NomixCacheProperties;
...
import com.lxzy.nomix.framework.tenant.core.aop.TenantIgnoreAspect;
import com.lxzy.nomix.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.lxzy.nomix.framework.tenant.core.job.TenantJobAspect;
import com.lxzy.nomix.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.lxzy.nomix.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.lxzy.nomix.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.lxzy.nomix.framework.tenant.core.redis.TenantRedisCacheManager;
import com.lxzy.nomix.framework.tenant.core.security.TenantSecurityWebFilter;
import com.lxzy.nomix.framework.tenant.core.service.TenantFrameworkService;
import com.lxzy.nomix.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.lxzy.nomix.framework.tenant.core.web.TenantContextWebFilter;
import com.lxzy.nomix.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "nomix.tenant", value = "enable", matchIfMissing = true) // 允许使用 nomix.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class NomixTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.lxzy.nomix.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     NomixCacheProperties nomixCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(nomixCacheProperties.getRedisScanBatchSize()));
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "com.lxzy.nomix.framework.quartz.core.handler.JobHandler")
