package com.lxzy.nomix.module.member.service.auth;

import cn.hutool.core.lang.Assert;
import com.lxzy.nomix.framework.common.enums.CommonStatusEnum;
import com.lxzy.nomix.framework.common.enums.TerminalEnum;
import com.lxzy.nomix.framework.common.enums.UserTypeEnum;
import com.lxzy.nomix.framework.common.util.monitor.TracerUtils;
...
import com.lxzy.nomix.module.member.convert.auth.AuthConvert;
...
import com.lxzy.nomix.module.system.api.logger.LoginLogApi;
...
import com.lxzy.nomix.module.system.api.sms.SmsCodeApi;
import com.lxzy.nomix.module.system.api.social.SocialClientApi;
import com.lxzy.nomix.module.system.api.social.SocialUserApi;
...
import com.lxzy.nomix.module.system.api.social.dto.SocialWxPhoneNumberInfoRespDTO;
import com.lxzy.nomix.module.system.enums.logger.LoginLogTypeEnum;
import com.lxzy.nomix.module.system.enums.logger.LoginResultEnum;
...
import static com.lxzy.nomix.module.member.enums.ErrorCodeConstants.*;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO Nomix：后续 member user 手机非强绑定，这块需要做下调整；
