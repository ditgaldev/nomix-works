package com.lxzy.nomix.module.member.controller.app.auth.vo;
...
public class AuthWeixinJsapiSignatureRespVO {
    ...
    @Schema(description = "URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nomix.cn")
    private String url;
