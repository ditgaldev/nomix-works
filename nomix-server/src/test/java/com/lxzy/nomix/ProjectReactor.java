...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.lxzy.nomix";
    private static final String ARTIFACT_ID = "nomix";
    private static final String PACKAGE_NAME = "com.lxzy.nomix";
    private static final String TITLE = "Nomix管理系统";
