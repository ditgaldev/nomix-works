package com.lxzy.nomix.module.mes.controller.admin.pro.route.vo.product;
...
@Schema(description = "管理后台 - MES 工艺路线产品 Response VO")
@Data
public class MesProRouteProductRespVO {
