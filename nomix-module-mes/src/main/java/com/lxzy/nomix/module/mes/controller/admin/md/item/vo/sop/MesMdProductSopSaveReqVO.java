package com.lxzy.nomix.module.mes.controller.admin.md.item.vo.sop;
...
@Schema(description = "管理后台 - MES 产品SOP新增/修改 Request VO")
@Data
public class MesMdProductSopSaveReqVO {
