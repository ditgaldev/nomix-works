package com.lxzy.nomix.module.mes.dal.dataobject.wm.returnissue;
 ...
 * MES 生产退料明细 DO
 */
@TableName("mes_wm_return_issue_detail")
@KeySequence("mes_wm_return_issue_detail_seq")
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class MesWmReturnIssueDetailDO extends BaseDO {
     ...
     * 行 ID
     *
     * 关联 {@link MesWmReturnIssueLineDO#getId()}
     */
    private Long lineId;
    /**
     * 库存记录 ID
