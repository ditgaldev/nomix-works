...
import com.lxzy.nomix.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
...
// TODO @Nomix：【对齐】前端没地方调用，这里只先写后端代码；
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return com.lxzy.nomix.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
