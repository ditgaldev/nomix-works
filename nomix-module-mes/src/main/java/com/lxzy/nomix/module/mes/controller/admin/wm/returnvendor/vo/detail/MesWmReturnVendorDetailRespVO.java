package com.lxzy.nomix.module.mes.controller.admin.wm.returnvendor.vo.detail;
...
@Schema(description = "管理后台 - MES 供应商退货明细 Response VO")
@Data
public class MesWmReturnVendorDetailRespVO {

    @Schema(description = "编号", example = "1")
    private Long id;

    @Schema(description = "退货单编号", example = "1")
    ...
    @Schema(description = "退货数量", example = "300.00")
