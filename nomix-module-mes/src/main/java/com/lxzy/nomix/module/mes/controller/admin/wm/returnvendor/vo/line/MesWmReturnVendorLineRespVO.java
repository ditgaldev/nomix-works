package com.lxzy.nomix.module.mes.controller.admin.wm.returnvendor.vo.line;
...
@Schema(description = "管理后台 - MES 供应商退货单行 Response VO")
@Data
public class MesWmReturnVendorLineRespVO {
    ...
    @Schema(description = "退货数量", example = "100.00")
