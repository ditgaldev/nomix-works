...
import com.lxzy.nomix.module.mes.dal.mysql.cal.plan.MesCalPlanMapper;
import com.lxzy.nomix.module.mes.enums.cal.MesCalPlanStatusEnum;
...
public class MesCalPlanServiceImpl implements MesCalPlanService {
    ...
    public void updatePlan(MesCalPlanSaveReqVO updateReqVO) {
        ...
        planMapper.updateWithShiftFieldCleanup(updateObj, clearShiftMethod, clearShiftCount);
    }
