package com.lxzy.nomix.module.mes.controller.admin.md.item;
...
import com.lxzy.nomix.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipPageReqVO;
import com.lxzy.nomix.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipRespVO;
import com.lxzy.nomix.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipSaveReqVO;
import com.lxzy.nomix.module.mes.dal.dataobject.md.item.MesMdProductSipDO;
import com.lxzy.nomix.module.mes.service.md.item.MesMdProductSipService;
...
public class MesMdProductSipController {
    ...
    public CommonResult<PageResult<MesMdProductSipRespVO>> getProductSipPage(@Valid MesMdProductSipPageReqVO pageReqVO) {
        ...
        // TODO @Nomix：工序模块实现后，补充 processCode/processName 的 JOIN 逻辑
