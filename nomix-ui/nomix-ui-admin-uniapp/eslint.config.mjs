...
export default uniHelper({
  ...
  rules: {
    ...
    // vue SFC 调换顺序改这里
    // 解释 by Nomix：为什么 script 开始放在 template 前面：https://yb.tencent.com/s/1fYYlgBopLAT
    'vue/block-order': ['error', {
      order: [['script', 'template'], 'style'],
    }],
    // add by Nomix：else、catch、} 等，不换行：https://zh-hans.eslint.org/docs/latest/rules/brace-style
