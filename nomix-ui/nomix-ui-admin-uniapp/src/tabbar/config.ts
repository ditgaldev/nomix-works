...
export const nativeTabbarList: NativeTabBarItem[] = [
  ...
  },
  {
    ...
    pagePath: 'pages/user/index', // edit by Nomix：原 me 被删除，改为 user 避免 IDE linter 报错
    text: '个人',
  },
]
...
export const customTabbarList: CustomTabBarItem[] = [
  ...
  // },
  // add by Nomix：图标可到 https://icon-sets.iconify.design/carbon/ 选择。另外，需要在 uno.config.ts 的 safelist 中添加图标类名
  {
    text: '工作台',
    pagePath: 'pages/index/index',
    iconType: 'unocss',
