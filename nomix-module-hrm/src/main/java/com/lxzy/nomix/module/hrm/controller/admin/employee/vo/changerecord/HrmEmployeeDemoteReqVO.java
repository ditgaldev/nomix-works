package com.lxzy.nomix.module.hrm.controller.admin.employee.vo.changerecord;

import com.lxzy.nomix.framework.common.validation.InEnum;
import com.lxzy.nomix.module.hrm.enums.employee.employment.HrmEmployeeChangeReasonEnum;
...
@Schema(description = "管理后台 - HRM 员工降级 Request VO")
@Data
public class HrmEmployeeDemoteReqVO {
    ...
    @Schema(description = "备注", example = "岗位职级调整")
    @Size(max = 500, message = "备注不能超过 500 个字符")
    private String remark;

    @AssertTrue(message = "降级原因不合法")
    @JsonIgnore
    public boolean isReasonValid() {
        return reason == null || HrmEmployeeChangeReasonEnum.DEMOTION_REASONS.contains(reason);
    }
