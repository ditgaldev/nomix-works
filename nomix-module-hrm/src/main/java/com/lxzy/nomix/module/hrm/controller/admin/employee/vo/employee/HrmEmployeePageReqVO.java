package com.lxzy.nomix.module.hrm.controller.admin.employee.vo.employee;

import com.lxzy.nomix.framework.common.pojo.SortablePageParam;
...
@Schema(description = "管理后台 - HRM 员工档案分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
public class HrmEmployeePageReqVO extends SortablePageParam {
    ...
    @Schema(description = "员工姓名、工号或手机号，模糊匹配", example = "张三")
