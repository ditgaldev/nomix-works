...
import com.lxzy.nomix.module.oa.controller.admin.meetingroom.vo.room.OaMeetingRoomSaveReqVO;
import com.lxzy.nomix.module.oa.dal.dataobject.meetingroom.OaMeetingRoomDO;
import com.lxzy.nomix.module.oa.dal.mysql.meetingroom.OaMeetingRoomMapper;
...
import static com.lxzy.nomix.module.oa.enums.ErrorCodeConstants.MEETING_ROOM_HAS_BOOKING;
...
public class OaMeetingRoomServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        ...
        new JdbcTemplate(dataSource).execute("CREATE ALIAS IF NOT EXISTS JSON_CONTAINS FOR "
                + "\"com.lxzy.nomix.module.oa.service.meetingroom.OaMeetingRoomServiceImplTest.jsonContains\"");
    }
