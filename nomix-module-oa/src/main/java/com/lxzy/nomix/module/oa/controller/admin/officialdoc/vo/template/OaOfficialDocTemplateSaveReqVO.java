package com.lxzy.nomix.module.oa.controller.admin.officialdoc.vo.template;

import com.lxzy.nomix.framework.common.enums.CommonStatusEnum;
import com.lxzy.nomix.framework.common.validation.InEnum;
import com.lxzy.nomix.framework.dict.validation.InDict;
...
public class OaOfficialDocTemplateSaveReqVO {
    ...
    @Schema(description = "红头名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nomix科技有限公司文件")
