package com.lxzy.nomix.module.oa.controller.admin.meetingroom.vo.room;
...
public class OaMeetingRoomSaveReqVO {
    ...
    @Schema(description = "会议室图片", example = "https://www.nomix.cn/meeting-room.jpg")
    ...
    @Schema(description = "附件地址列表", requiredMode = Schema.RequiredMode.REQUIRED, example = "[\"https://www.nomix.cn/meeting.pdf\"]")
