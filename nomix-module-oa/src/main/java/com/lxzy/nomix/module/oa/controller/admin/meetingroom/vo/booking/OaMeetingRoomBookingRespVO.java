package com.lxzy.nomix.module.oa.controller.admin.meetingroom.vo.booking;
...
public class OaMeetingRoomBookingRespVO {
    ...
    @Schema(description = "附件地址列表", example = "[\"https://www.nomix.cn/meeting.pdf\"]")
    ...
    @Schema(description = "主持人姓名", example = "Nomix")
    private String moderatorName;

    @Schema(description = "参会人姓名", example = "[\"Nomix\",\"小王\"]")
    private List<String> attendeeNames;

    @Schema(description = "申请人", example = "Nomix")
