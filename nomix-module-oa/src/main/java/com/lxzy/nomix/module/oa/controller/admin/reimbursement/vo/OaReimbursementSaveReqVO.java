package com.lxzy.nomix.module.oa.controller.admin.reimbursement.vo;
...
public class OaReimbursementSaveReqVO {
    ...
    @Schema(description = "相关客户", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nomix科技有限公司")
