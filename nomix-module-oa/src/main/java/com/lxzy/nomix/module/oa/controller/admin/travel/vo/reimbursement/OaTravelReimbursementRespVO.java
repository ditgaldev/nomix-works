package com.lxzy.nomix.module.oa.controller.admin.travel.vo.reimbursement;
...
@Schema(description = "管理后台 - 出差报销 Response VO")
@Data
public class OaTravelReimbursementRespVO {

    @Schema(description = "编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
    private Long id;

    @Schema(description = "单据编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "CLBX202609140001")
    private String no;
    ...
    @Schema(description = "支付状态", requiredMode = Schema.RequiredMode.REQUIRED, example = "false")
    private Boolean payStatus;

    @Schema(description = "报销总金额", example = "100.00")
    private BigDecimal totalPrice;

    @Schema(description = "关联出差单号", example = "CC202609140001")
    ...
    private List<OaTravelReimbursementDO.Item> items;
