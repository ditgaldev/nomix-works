package com.lxzy.nomix.module.oa.controller.admin.contact.vo;
...
public class OaContactRespVO {
    ...
    @Schema(description = "创建人用户昵称", example = "Nomix源码")
    ...
    @Schema(description = "邮箱", example = "nomix@example.com")
    private String email;

    @Schema(description = "地址", example = "上海市浦东新区世纪大道 100 号")
    private String address;

    @Schema(description = "公司名称", example = "Nomix科技有限公司")
    ...
    @Schema(description = "分享给当前用户的共享人昵称", example = "Nomix源码")
    ...
    public static class Share {
        ...
        @Schema(description = "共享接收人用户昵称", example = "Nomix源码")
